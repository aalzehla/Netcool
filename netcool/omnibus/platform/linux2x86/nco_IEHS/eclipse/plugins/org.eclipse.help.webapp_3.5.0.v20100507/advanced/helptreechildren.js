...
function updateTree(xml, treeAriaLabel) { 
    ...
    if(nodes.length > 0){
    	setAccessibilityRole(treeRoot, WAI_TREE);
    	setAccessibilityLabel(treeRoot, treeAriaLabel);
    }
    selectedNode = null;
...
function addChild(treeItem, id, name, href, image, closedImage, imageAltText, isLeaf, position, setsize, level) {        
