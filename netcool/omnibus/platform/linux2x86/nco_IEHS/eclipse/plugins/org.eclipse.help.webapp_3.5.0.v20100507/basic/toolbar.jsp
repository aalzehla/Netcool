...
<body dir="<%=direction%>" bgcolor="<%=prefs.getBasicToolbarBackground()%>" role="navigation">
<h1 id="_toolbarTitle" style="display:none;"><%=ServletResources.getString("Toolbar", request)%></h1>
<%
...
%>
	<b role="region" aria-labelledby="_toolbarTitle">
	<%=title%>
	</b>
