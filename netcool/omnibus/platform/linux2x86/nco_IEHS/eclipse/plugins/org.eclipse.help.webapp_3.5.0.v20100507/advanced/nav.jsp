...
<frameset role="main" aria-label="<%=ServletResources.getString("Help", request)%>" id="navFrameset" rows="*,21"  framespacing="0" border="0"  frameborder="0" scrolling="no">
   <frame name="ViewsFrame" title="<%=ServletResources.getString("ignore", ServletResources.getString("ViewsFrame", request), request)%>" src='<%="views.jsp"+UrlUtil.htmlEncode(data.getQuery())%>' marginwidth="0" marginheight="0" scrolling="no" frameborder="0" resize=yes>
