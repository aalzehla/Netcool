...
function setAccessibilityLabel(node, label){
	node.setAttribute("aria-label", label);
}

function setAccessibilityLabelledBy(node, refID){
	node.setAttribute("aria-labelledby", refID);
}
