...
<h1 id="_indexViewTitle" style="display:none;"><%=ServletResources.getString("Content", request)%></h1>
<table role="region" aria-labelledby="_indexViewTitle" border="0" cellpadding="0" cellspacing="0">
<%
