...
function onloadHandler(e)
{
    ...
    <frameset role="main" aria-label="<%=ServletResources.getString("Help", request)%>" id="contentFrameset" rows="<%=frameData.getContentAreaFrameSizes()%>" frameborder="1" framespacing="3" border="6" spacing="0">
