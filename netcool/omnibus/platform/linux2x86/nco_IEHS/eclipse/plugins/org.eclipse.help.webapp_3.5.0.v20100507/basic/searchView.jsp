...
<h1 id="_searchViewTitle" style="display:none;"><%=ServletResources.getString("SearchResults", request)%></h1>
<%
if (data.isProgressRequest()) {
%>
<table role="region" aria-labelledby="_searchViewTitle" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td>
...
%>
<tr>
	<td align='<%=isRTL?"left":"right"%>'><img src="../<%=pluginVersion%>/basic/<%=prefs.getImagesDirectory()%>/topic.gif" alt=""/></td>
