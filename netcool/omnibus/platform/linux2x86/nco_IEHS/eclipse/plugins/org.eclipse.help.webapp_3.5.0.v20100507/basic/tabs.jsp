...
<body dir="<%=direction%>" bgcolor="<%=prefs.getBasicToolbarBackground()%>" link="#0000FF" vlink="#0000FF" alink="#0000FF" role="region" aria-label="<%=ServletResources.getString("Tabs", request)%>">
	<h1 id="_tabsTitle" style="display:none;"><%=ServletResources.getString("Tabs", request)%></h1>
	<table role="navigation" aria-labelledby="_tabsTitle" align="<%=isRTL?"right":"left"%>" border="0" cellpadding="0" cellspacing="0">
	<tr>
