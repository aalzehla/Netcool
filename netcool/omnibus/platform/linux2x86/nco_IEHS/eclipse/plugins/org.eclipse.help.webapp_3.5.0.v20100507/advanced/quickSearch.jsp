...
<% 
    ...
    String quickSearchTitle = data.isSelectedTopicQuickSearchRequest()? "QuickSearchTopic.title":"QuickSearchToc.title";
%>

<html lang="<%=ServletResources.getString("locale", request)%>">
<head>
<title><%= ServletResources.getString(quickSearchTitle, request)%></title>
...
<body dir="<%=direction%>" onload="onloadHandler()" role="main">
<h1 id="quickSearchTitle" style="display:none;"><%= ServletResources.getString(quickSearchTitle, request)%></h1>
<form onsubmit="doQuickSearch();return false;" role="form" aria-labelledby="quickSearchTitle">
			...
			<tr id="buttonsTable"><td align="<%=isRTL?"left":"right"%>">
	  			<table role="presentation" cellspacing=0 cellpadding=0 border=0 style="background:transparent;">
					<tr>
						...
						<td>
						  	<button type="reset" onclick="window.close()" id="cancel" role="button"><%=ServletResources.getString("Cancel", request)%></button>
						</td>
					</tr>
	  			</table>
			</td></tr>
