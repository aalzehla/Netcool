...
function setEnvelopeHeader(envelopeHeader) {
    return envelopeHeader="<env:Envelope xmlns:env=\"http://schemas.xmlsoap.org/soap/envelope/\" \n"+
...
function CT_Get (itmHost, itmPort, userName, password,object,target,attribute,history,results,returnEnv) {
    ...
    var  envelopeHeader = "";
    envelopeHeader=setEnvelopeHeader(envelopeHeader); 
    body=envelopeHeader +"\n"+
        "   <env:Body>\n"+
        "      <ns0:Get>\n"+
        "         <CT_Get>\n"+
    ...
    Log("Body is " + body); 
   return setAndSendTheRequest(itmHost,itmPort,body,returnEnv);
} 
